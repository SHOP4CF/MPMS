...
/**
 * Created by ktraganos on 14-2-2018.
 */
@Named
public class SendCOBOTTaskInfoListener implements TaskListener {

    private final static Logger LOGGER = Logger.getLogger(SendCOBOTTaskInfoListener.class.getName());
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        jsonBody = Json.createObjectBuilder()
                ...
                .add("product_no", productNo).build();


        ComposeTaskMessage composeTaskMessage = ComposeTaskMessage.instance;
        String message = composeTaskMessage.compose(delegateTask.getExecution(),taskName,taskInstanceId,autoAgentsIDs, "COBOT", jsonBody);
