 ...
 */
@Named
public class SendARTaskInfoListener implements TaskListener {

    private final static Logger LOGGER = Logger.getLogger(SendARTaskInfoListener.class.getName());
...
//        autoAgentsIDs = delegateTask.getExecution().getVariable("roleA_AgentID").toString();
        ...
        String message = composeTaskMessage.compose(delegateTask.getExecution(),taskName,taskInstanceId,autoAgentsIDs, "AR", jsonBody);
