...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "mpms_core";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "mpms_core.war")
            ...
            .addPackages(false, "tue.horse") // not recursive to skip package 'nonarquillian'
